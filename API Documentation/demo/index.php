...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/demo/css/flexigrid.css" />
	<link rel="stylesheet" type="text/css" href="/demo/css/style.css" />
	<script src="/demo/js/url-builder.js"></script>
	<script src="/demo/js/jquery-1.8.3.min.js"></script>
	<script src="/demo/js/jquery-ui-1.9.2.custom.min.js"></script>
	<script type="text/javascript" src="/demo/js/flexigrid.js"></script>
	<script type="text/javascript" src="/demo/js/album-info.js"></script>
	<script type="text/javascript" src="/demo/js/albums-tab.js"></script>
	<script type="text/javascript" src="/demo/js/participants-tab.js"></script>
	<script type="text/javascript" src="/demo/js/tracks-tab.js"></script>
	<script type="text/javascript" src="/demo/js/works-tab.js"></script>
	<script type="text/javascript" src="/demo/js/util.js"></script>
	<script type="text/javascript" src="/demo/js/date.js"></script>
	<script>
